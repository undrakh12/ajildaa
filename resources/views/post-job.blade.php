                        ...
                        <div class="uk-width-1-1">
                            ...
                            <div id="modal-full3" class="uk-modal-full" uk-modal>
                                <div class="uk-modal-dialog full-modal">
                                    ...
                                    <div class="uk-text-center uk-padding">
                                        <a class="uk-button uk-button-primary btn uk-modal-close next" href="/job" onclick="UIkit.notification({message: '<span uk-icon=\'icon: check\'></span> Амжилттай...', status: 'success'})">Амжилттай</a>
                                    </div>
                                </div>
                            </div>
